...
详细验收 gate 见 `docs/mvp1-acceptance.md`。风险等级和用户可见文案见 `docs/mvp1-risk-copy.md`。
...
诊断报告样本必须放在 `fixtures/diagnostic/reports/`，并通过：
...
MVP 2 预研草案见 `docs/mvp2-write-draft.md`。进入 MVP 2 实现前，必须先完成 `docs/security-checklist.md` 中的 MVP 2 Write Gate。
